...
/**
 * The tag for the criteria component.
 *
 * @internal
 */
const CRITERIA_TAG = 'Criteria' as const;
 ...
 * @internal
 */
type CriteriaSchema = { Type: n.Any; Tag: 'Schema' };
 ...
 * @internal
 */
type CriteriaConstructor<Params extends n.Any[], S extends CriteriaSchema> = (
  ...params: Params
) => Logic<S, S['Type']>;
 ...
 * @public
 */
type Criteria<T, Args extends n.Any[] = never[]> = n.Component<
  typeof CRITERIA_TAG,
  & {
 ...
 * @internal
 */
class CriteriaComposer<T, Args extends n.Any[]> {
   ...
   */
  public and<Args2 extends n.Any[]>(other: Criteria<T, Args2>): Criteria<T, [...Args, ...Args2]> {
    ...
    const andCriteria = n.component(CRITERIA_TAG, andCriteriaFn, andComposer, {
      other,
    }) as Criteria<
      T,
      [...Args, ...Args2]
   ...
   */
  public or<Args2 extends n.Any[]>(other: Criteria<T, Args2>): Criteria<T, [...Args, ...Args2]> {
    ...
    // Use the other criteria's as part of the uniqueness.
    const orCriteria = n.component(CRITERIA_TAG, orCriteriaFn, orComposer, { other }) as Criteria<
      T,
      [...Args, ...Args2]
    >;
  ...
  public not(): Criteria<T, Args> {
    ...
    return n.component(CRITERIA_TAG, notCriteriaFn, notComposer, {
   ...
   * @private
   */
  private splitArgs<Args2 extends n.Any[]>(
 ...
 * @public
 */
const criteria = <Params extends n.Any[], S extends CriteriaSchema>(
  ...
  const criteriaComponent = n.component(CRITERIA_TAG, criteriaFn, composer) as Criteria<
    S['Type'],
    Params
  >;
