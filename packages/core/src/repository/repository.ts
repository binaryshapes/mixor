...
interface RepositoryDataSource<E extends RepositoryEntity> {
   ...
   */
  match(criteria: Criteria<E['Type'], Any[]>): E['Type'] | undefined;
   ...
   */
  matchAll(criteria: Criteria<E['Type'], Any[]>): E['Type'][];
   ...
   */
  delete(criteria: Criteria<E['Type'], Any[]>): boolean;
 ...
 * @public
 */
class RepositoryPanic extends Panic<'Repository', 'DataSourceNotFound'>('Repository') {}
...
class RepositoryBuilder<E extends RepositoryEntity, C extends RepositoryCriteria<E>> {
  ...
  public match<K extends keyof C>(key: K, ...params: Parameters<C[K]>) {
    ...
    return this.ds.match(this.criteria[key](...params) as Criteria<E['Type'], Any[]>);
  }
  ...
  public matchAll<K extends keyof C>(key: K, ...params: Parameters<C[K]>) {
    ...
    return this.ds.matchAll(this.criteria[key](...params) as Criteria<E['Type'], Any[]>);
  }
  ...
  public delete(criteria: Criteria<E['Type'], Any[]>) {
    if (!this.ds) {
      throw new RepositoryPanic('DataSourceNotFound', 'Data source not found');
    }
...
const repository = <E extends RepositoryEntity, C extends RepositoryCriteria<E>>(
  ...
  component('Repository', new RepositoryBuilder<E, C>(entity, criteria))
    .addChildren(entity, ...Object.values(criteria)) as unknown as Repository<E, C>;
